...
public class DAOConfigs {
    ...
    //в случае круговых зависимостей мы не можем так сконфигурировать будет выдавать ошибку
    // поэтому пишем третий сервис где эти два взаимодействуют
    //автоварид ставим на сеттер
    //а так пишем конфигурационный класс
}
